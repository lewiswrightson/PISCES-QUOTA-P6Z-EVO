...
CONTAINS
   ...
   SUBROUTINE p6z_meso( kt, knt, Kbb, Kmm, Krhs )
      ...
      REAL(wp) :: zr_diaz, zsizedzn, zsizedzd
      !
      ...
      DO_3D( nn_hls, nn_hls, nn_hls, nn_hls, 1, jpkm1)
         ...
         ztmp4     = xpref2d * zcompadi * ( zcompadi + zdiffdn * zcompaph + zdiffdzd * zcompadz ) /( 1.0 + zdiffdn + zdiffdzd )
         !ztmp4     = xpref2d * zcompadi * ( zcompadi + zdiffdn * zcompaph ) /( 1.0 + zdiffdn )
         ztmp5     = xpref2z * zcompaz * zcompaz
         ztmp6     = xpref2dz * zcompadz * (zcompadz + zdiffdzn * zcompaph + zdiffdzd * zcompadi ) / ( 1.0 + zdiffdzn + zdiffdzd )
         ...
         ! Diazotroph
         zgrazdzc  = zproportm1 * zgrazdzc 
         zgrazdzn  = zproportm1 * zgrazdzn 
         zgrazdzp  = zproportm1 * zgrazdzp 
         zgrazdzf  = zproportm1 * zgrazdzf   
